...
//   const [granteeType, setGranteeType] = useState('doctor');
...
//     ) {
//       setError(
//         'You cannot share your records with yourself.'
//       );
//       return;
//     }
...
//     try {
//       // Check whether this person already has access
...
//       if (existing) {
//         setError(
//           'This person already has access to your records.'
//         );
//         return;
//       }
...
//           : 'Access granted to the family member successfully.'
//       );
...
//     const confirmed = window.confirm(
//       'Are you sure you want to revoke this person\'s access to your health records?'
//     );
...
//         <p className="mt-1 text-sm text-slate-500">
//           Securely share your health records with
//           doctors or trusted family members.
//         </p>
//       </div>
...
//         <p className="mb-5 text-sm text-slate-500">
//           Choose who you want to share your health
//           records with.
//         </p>
...
//             <p className="mt-1 text-sm text-slate-500">
//               You haven't shared your health records
//               with anyone yet.
//             </p>
...
//         <p className="mt-2 text-sm leading-6 text-slate-600">
//           You choose who can access your health
//           records. You can revoke access at any
//           time.
//         </p>
